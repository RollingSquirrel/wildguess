    ...
    <div class="min-h-screen flex items-center justify-center p-4">
      <div class="register-card w-full max-w-md" role="main">
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()" class="space-y-5">
          <div>
            <label for="reg-username" class="block text-sm font-medium text-[var(--color-text-secondary)] mb-1.5">
              Username
            </label>
            <input
              id="reg-username"
        ...
        <p class="text-center text-[var(--color-text-secondary)] text-sm mt-6">
          ...
          <a routerLink="/login" class="text-[var(--color-primary)] hover:underline font-medium">Sign in</a>
        </p>
      </div>
    </div>
  `,
